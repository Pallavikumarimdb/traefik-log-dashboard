...
<Callout title="Requires GeoIP Database" type="info">
Geographic features require MaxMind GeoLite2 databases. See [configuration](/docs/configuration) for setup.
</Callout>
...
- **MaxMind Support**: Integrated GeoLite2-City and GeoLite2-Country databases
- **IP Lookup API**: Expose geolocation as API endpoints
- **Private IP Handling**: Special treatment for 10.x, 192.168.x, 11.x ranges
